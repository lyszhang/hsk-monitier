...
def get_tx_info_daily(api_base, etherscan_url, gate_url, target_date):
    ...
    fee_income = get_fee_income_info(target_date)
    ...
    dispute_fee = get_account_fee_in_ethereum_daily(etherscan_url, target_date,dispute_game_sender, dispute_game_factory)
    batcher_fee = get_account_fee_in_ethereum_daily(etherscan_url, target_date,batch_sender, batch)
